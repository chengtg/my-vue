<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      ...
      <template v-if="dataForm.parentId === 0">
        <el-form-item label="竞租铺位发布" prop="bidRentPublicityId">
           <template v-if="dataForm.id === 0 ">
              <el-select v-model="dataForm.bidRentPublicityId" :disabled="dataForm.parentId !== 0" filterable clearable placeholder="铺位发布标题" style="width:800px;">
                <el-option
                  v-for="item in SHOP_PUSH_LIST_Options"
                  :key="item.id"
                  :label="item.title"
                  :value="item.id">
                </el-option>
           ...
           <template v-else>
             <el-input v-model="dataForm.pushTitle" :disabled="true" placeholder="竞租铺位发布"></el-input>
           </template>
        </el-form-item>
        ...
        <el-form-item label="模板内容" prop="content">
          <el-input type="textarea" v-model="dataForm.content" placeholder="消息内容"></el-input>
        </el-form-item>
      </template>
      <template v-else>
        <el-form-item label="竞租铺位发布" prop="pushTitle">
          <el-input v-model="dataForm.pushTitle" :disabled="true" placeholder="竞租铺位发布"></el-input>
        </el-form-item>
        ...
        <el-form-item label="消息类型" prop="type">
         ...
         <el-form-item label="消息内容" prop="content">
           <el-input type="textarea" v-model="dataForm.content" :autosize="{ minRows:5, maxRows: 10}" placeholder="消息内容"></el-input>
         </el-form-item>
          <el-form-item label="是否立即发送" prop="isSend">
            <el-switch v-model="dataForm.isSend"></el-switch>
          </el-form-item>
      ...
      <!--<el-form-item label="接收人" prop="subType" >
        <el-select v-model="dataForm.recipientIdList"  multiple  :disabled="isDisabled"  placeholder="接收人">
          <el-option
            v-for="item in MERCHANTS_Options"
            :key="item.id"
            :label="item.name"
            :value="item.id">
          </el-option>
  ...
  export default {
    ...
    methods: {
      init(id, parent) {
        ...
        this.dataForm.bidRentPublicityId = '';
        this.visible = true;
        this.fileList = [];// 情况上次文件
        this.$nextTick(() => {
          ...
          if (typeof (parent) === 'undefined' || parent == null) {
            ...
            this.dataForm.bidRentPublicityId = parent.bidRentPublicityId;
            this.dataForm.pushTitle = parent.pushTitle;
          }
