  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item label="铺位编号" prop="shopId">
        ...
        <el-select v-model="dataForm.shopId"   placeholder="请选择铺位">
          <el-option
      ...
      <el-form-item label="预审状态" prop="perStatus">
        <el-select v-model="dataForm.perStatus"  clearable placeholder="预审状态">
          <el-option
      ...
      <el-form-item label="二审状态" prop="secondStatus">
        <el-select v-model="dataForm.secondStatus"  clearable placeholder="二审状态">
          <el-option
            v-for="item in STATUS_Options"
            :key="item.value"
            :label="item.label"
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('bunk:tmerchantsapply:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button v-if="isAuth('bunk:tmerchantsapply:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
...
<!--  <el-table-column
        ...
        header-align="center"
        align="center"
        label="铺位发布ID(铺位发布表ID)">
      </el-table-column>-->
      <!-- <el-table-column  header-align="center" label="铺位发布信息"> -->
          <el-table-column
            prop="projectName"
            header-align="center"
            align="left"
          ...
          <el-popover trigger="situation" placement="top">
            <b>1、品牌类别:</b><p class="breakword">{{ scope.row.bigTypeName }} - {{ scope.row.subType }}</p>
            <div slot="reference">
      ...
      <!-- <el-table-column  header-align="center" label="竞租资料">
      ...
      <!-- </el-table-column> -->
      <!-- <el-table-column  header-align="center" label="预审信息"> -->
        <el-table-column
          prop="preAuditStatus"
          header-align="center"
          align="left"
          ...
          <template slot-scope="scope">
            <el-popover trigger="situation" placement="top">
              ...
              <b>2、预审人:</b><p class="breakword">{{ scope.row.preAuditor }}</p>
          ...
          <!-- <template slot-scope="scope">
            <el-tag v-if="scope.row.preAuditStatus == 0" size="small" type="danger">未审核</el-tag>
            <el-tag v-else-if="scope.row.preAuditStatus == 1" size="small" type="small">审核通过</el-tag>
            <el-tag v-else size="danger">审核失败</el-tag>
          </template> -->
        </el-table-column>
        <!-- <el-table-column
          prop="preAuditInfo"
      ...
      <!-- </el-table-column> -->
      <!-- <el-table-column  header-align="center" label="二审信息"> -->
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-popover trigger="situation" placement="top">
              <b>1、二审信息:</b><p class="breakword">{{ scope.row.secondAuditInfo }}</p>
              <b>2、审核人:</b><p class="breakword">{{ scope.row.secondAuditor }}</p>
              <b>3、二审时间:</b><p class="breakword">{{ scope.row.secondAuditTime }}</p>
              <div slot="reference">
                <el-button v-if="scope.row.preAuditStatus == 0" type="warning" plain icon="el-icon-warning" size="mini">未审核</el-button>
                <el-button v-else-if="scope.row.preAuditStatus == 1" type="success" plain icon="el-icon-success" size="mini">审核通过</el-button>
                <el-button v-else type="danger" icon="el-icon-danger" plain size="mini">审核失败</el-button>
          ...
          <!-- <template slot-scope="scope">
            <el-tag v-if="scope.row.secondAuditStatus == 0" size="small" type="danger">未审核</el-tag>
            <el-tag v-else-if="scope.row.secondAuditStatus == 1" size="small" type="small">审核通过</el-tag>
            <el-tag v-else size="danger">审核失败</el-tag>
          </template> -->
        </el-table-column>
        <!-- <el-table-column
          prop="secondAuditInfo"
          header-align="center"
          align="center"
          label="二审信息">
        </el-table-column>
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" v-if="isAuth('bunk:tmerchantsapply:update')"  size="small" @click="addOrUpdateHandle(scope.row.id)">修改</el-button>
          <el-button type="text" v-if="isAuth('bunk:tmerchantsapply:delete')" size="small" @click="deleteHandle(scope.row.id)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    methods: {
      ...
      getDataList() {
        ...
        var params = {
          ...
          preAuditStatus: this.dataForm.perStatus,
          secondAuditStatus: this.dataForm.secondStatus,
