    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" v-if="isAuth('bunk:tmerchantsapply:prestate')" size="small" @click="auditHandle(scope.row.id)">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
    ...
    methods: {
      ...
      getDataList() {
        ...
        var params = {
          ...
          preAuditStatus: this.dataForm.perStatus, // 如果没有选择预审状态默认是未审核
      ...
      exportExcel() {
        ...
        var params = {
          ...
          isFirst: this.dataForm.isFirst,
          key: this.dataForm.key,
          auditStatus: '1'// 1=预审阶段
        };
        this.$http({
          url: this.$http.adornUrl(`/bunk/tmerchantsapply/exportExcel`),
          method: 'get',
