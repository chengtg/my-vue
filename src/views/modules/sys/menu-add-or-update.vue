<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <el-form-item v-if="dataForm.type === 1" label="数据库表" prop="perms">
          <el-input v-model="dataForm.menuTable" placeholder="模块数据库表"></el-input>
        </el-form-item>
        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.menuTable = data.menu.menuTable;
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'menuTable': this.dataForm.menuTable,
